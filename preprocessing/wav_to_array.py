...
for filename in file_List:
    ...
    #print("The sampling frequency is: " + str(sampling_freq))
    ...
    cqt_feat = np.absolute(librosa.cqt(mono_vector, DOWNSAMPLED_SR, hop_length=hop_length_in,n_bins=n_bins_in,bins_per_octave=bins_octaves_in)).transpose()
    #### LABELING ####
