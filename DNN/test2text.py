...
num_test_batches = int(len([name for name in os.listdir(data_directory )])/2)
...
main_data.write("R = " + str("%.6f" % R) + "\n")
main_data.write("P = " + str("%.6f" % P) + "\n")
main_data.write("A = " + str("%.6f" % A) + "\n")
main_data.write("F = " + str("%.6f" % F) + "\n")
main_data.close()
